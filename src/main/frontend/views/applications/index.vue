    ...
    <div class="container">
      ...
      <div class="level applications-stats">
        <div class="level-item has-text-centered">
          <div>
            <p class="heading">应用(Applications)</p>
            <p class="title" v-text="applicationsCount">1</p>
          </div>
        </div>
        <div class="level-item has-text-centered">
          <div>
            <p class="heading">实例(Instances)</p>
            <p class="title" v-text="instancesCount">1</p>
          </div>
        </div>
        <div class="level-item has-text-centered">
          <div v-if="downCount === 0">
            <p class="heading">状态(Status)</p>
            <p class="title has-text-success">在线(up)</p>
          </div>
          <div v-else>
            <p class="heading">离线(down)</p>
      ...
      <div v-if="statusGroups.length === 0">
        <p class="is-muted">无应用注册(No applications registered)</p>
      </div>
    </div>
  </section>
</template>
