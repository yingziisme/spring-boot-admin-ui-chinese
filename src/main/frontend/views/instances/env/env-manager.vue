...
<template>
  <div class="box">
    <h1 class="is-size-5">环境管理(Environment Manager)</h1>
        ...
        <div class="field">
          <div class="control">
            <sba-confirm-button class="button is-light"
              ...
              <span v-if="refreshStatus === 'completed'">内容已刷新(Context refreshed)</span>
              <span v-else-if="refreshStatus === 'failed'">失败(Failed)</span>
              <span v-else>刷新内容(Refresh Context)</span>
            </sba-confirm-button>
          </div>
        </div>
      </div>
        ...
        <div class="field is-grouped is-grouped-right">
          <div class="control">
            <button class="button is-light"
              ...
              <span v-if="resetStatus === 'completed'">重置(Resetted)</span>
              <span v-else-if="resetStatus === 'failed'">失败(Failed)</span>
          ...
          <div class="control">
            <button class="button is-primary"
              ...
              <span v-if="updateStatus === 'completed'">已更新(Updated)</span>
              <span v-else-if="updateStatus === 'failed'">失败(Failed)</span>
              <span v-else>更新(Update)</span>
            </button>
          </div>
        </div>
      </div>
