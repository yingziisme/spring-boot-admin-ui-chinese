...
<template>
  <table class="httptraces table is-hoverable is-fullwidth">
    <thead>
      <tr>
        <th class="httptraces__trace-timestamp">时间戳(Timestamp)</th>
        <th class="httptraces__trace-method">方法(Method)</th>
        <th class="httptraces__trace-uri">路径(Path)</th>
        <th class="httptraces__trace-status">状态(Status)</th>
        <th class="httptraces__trace-contentType">内容类型(Content-Type)</th>
        <th class="httptraces__trace-contentLength">长度(Length)</th>
        <th class="httptraces__trace-timeTaken">时长(Time)</th>
      </tr>
    </thead>
    <tbody>
